...
export const metadata: Metadata = {
  title: "Pilates Flow - Transform Your Body & Mind",
  description: "Join our vibrant pilates studio. Expert instructors, diverse classes, and real results. Start your free trial today.",
  keywords: "pilates classes, pilates studio, reformer pilates, core strength, fitness, pilates instructor",
  metadataBase: new URL("https://pilatesflow.com"),
  alternates: {
    canonical: "https://pilatesflow.com"
  },
  openGraph: {
    title: "Pilates Flow - Premium Pilates Studio",
    description: "Transform your body with expert pilates instruction. Classes for all levels in a supportive community.",
    url: "https://pilatesflow.com",
    siteName: "Pilates Flow",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765807824408-mgoebr7j.jpg",
      alt: "Pilates Flow studio"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Pilates Flow - Transform Your Body",
    description: "Join our pilates community today",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1765807824408-mgoebr7j.jpg"]
  },
  robots: {
    index: true,
    follow: true
